...
const Footer = () => {
  return (
    <footer className="font-league-spartan text-center py-6 mt-12 text-gray-400">
      ...
      <p>
        <a href="https://github.com/jiwa310/PersonalSiteV1" target="_blank" rel="noreferrer" className="font-league-spartan hover:text-yellow-400 hover:underline text-gray-400">
