  ...
  return (
    <section id="projects" className="min-h-screen text-left pt-20 pl-20 pr-20 flex flex-col">
      ...
      <div className="flex flex-col gap-8">
        {/* Project 1 */}
        <a href="https://sentimentsub.com" target="_blank" rel="noopener noreferrer" className="border border-gray-300 p-4 rounded hover:border-yellow-400 transition duration-200 flex items-start transform hover:-translate-y-1 hover:-translate-x-1 hover:shadow-yellow">
        ...
        {/* Project 2 */}
        <a href="https://chatcheck.com" target="_blank" rel="noopener noreferrer" className="border border-gray-300 p-4 rounded hover:border-yellow-400 transition duration-200 flex items-start transform hover:-translate-y-1 hover:-translate-x-1 hover:shadow-yellow">
