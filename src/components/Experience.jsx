  ...
  return (
    <section id="experience" className="min-h-screen text-left pt-20 pl-5 md:pl-20 pr-10 flex flex-col">
      ...
      <div className="flex mb-8">
        ...
        <div className="w-3/4">
          <h3 className="text-2xl font-semibold mb-2">Software Engineer Intern at <a href="https://biopacificmip.org/" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 transition duration-200 hover:underline">NSF BioPacific MIP</a></h3>
